  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <p className="max-w-md">
            من الاستراتيجيه الي التنفيذ نصمم حلولا رقميه تدفع اعمالك الي الامام
          </p>
        ...
        >
          <h3 className="font-semibold">اشترك في نشرتنا الاخباريه</h3>
          <p className="text-sm mt-2 mb-6">
            اخر الاخبار والموارد والمقالات ترسل الي بريدك الوارد اسبوعيا
          </p>
      ...
      className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
        <p><span className="text-[#FF4500] font-bold">Tux Studio</span>. جميع الحقوق محفوظة.</p>
        <p>
          <a href="https://amdadislam.netlify.app/">Developed By Osama Esam</a>
        </p>
